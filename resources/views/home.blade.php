            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="banner-text text-left text-white">
                        ...
                        <a href="https://poocoin.app/tokens/0x326E6EB9a13DEbfC5cD5Cf6eec6B45c3228358ec" class="button bt-white iq-mt-20 iq-ml-10" style="background:#DD00AE;color:white">CHART</a>
                        <a href="https://pancakeswap.finance/swap?outputCurrency=0x326E6EB9a13DEbfC5cD5Cf6eec6B45c3228358ec" class="button bt-white iq-mt-20 iq-ml-10" style="background:#DD00AE;color:white">BUY PIG</a>
                    </div>
                </div>
